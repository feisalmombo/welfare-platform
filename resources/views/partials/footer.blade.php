    ...
    <footer class="col-sm-12">
        <div class="footer-copyright text-center" style="padding-top: 15px;">
             <strong style>Copyright &copy; {{ date('Y') }} <a href="http://getpesa.co.tz/"  target="_blank" style="text-decoration: none; color:black;">GetPesa PLC</a> .</strong> All rights reserved.
         </div>
     </footer>
