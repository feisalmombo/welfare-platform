...
<html lang="en">
  <head>
    ...
    <title>Welfare Application - Welcome</title>
...
<div class="w3l-bootstrap-header fixed-top">
    <nav class="navbar navbar-expand-lg navbar-light p-2">
      <div class="container">
      <a class="navbar-brand" href="{{url('/')}}"><strong style="color:#BE2434">Welfare</strong></a>
    ...
    <footer class="footer-28">
        ...
        <div class="container py-lg-3">
            ...
            <div class="col-md-6 footer-list-28 mt-5">
                <h1 class="footer-title-28"><strong style="color: #BE2434;">Welfare</strong></h1>
